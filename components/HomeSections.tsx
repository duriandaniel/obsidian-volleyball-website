    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal>
            <div className="mb-12 lg:mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              <div>
                <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">SEE OUR COACHING IN ACTION</p>
                <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-white tracking-wide">
                  ON <span className="text-[#7E57C2]">COURT</span>
                </h2>
              </div>
              <a
                ...
                className="inline-flex items-center gap-2 text-[#7E57C2] text-sm font-medium tracking-wide hover:text-white transition-colors"
              >
                More on Instagram
      ...
      <section id="about" className="py-24 lg:py-32 bg-[#111]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-24 items-center">
            <SectionReveal>
              <div>
                <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">OUR STORY</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal>
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
              <div>
                <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">YOUR TEAM</p>
      ...
      <section id="jerseys" className="py-24 lg:py-32 bg-[#0A0A0A]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-16 items-center">
            <SectionReveal>
              <div>
                <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">GEAR UP</p>
                <h2 className="font-heading text-5xl lg:text-7xl text-white tracking-wide mb-8">
                  OBSIDIAN
                  <br />
                  <span className="text-[#7E57C2]">TRAINING JERSEY</span>
                </h2>
      ...
      <section id="location" className="py-24 lg:py-32 bg-[#0A0A0A]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal>
            <div className="mb-16">
              <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">FIND US</p>
            ...
            <SectionReveal>
              <div className="space-y-8">
                ...
                <div className="border-t border-white/[0.06] pt-8">
                  ...
                  <h3 className="font-heading text-2xl text-[#7E57C2] mb-3 tracking-wide">BAULKHAM HILLS HIGH SCHOOL</h3>
                  <address className="not-italic space-y-1 text-gray-300 text-sm">
      ...
      <section id="faq" className="py-24 lg:py-32 bg-[#111]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal>
            <div className="mb-16">
              <p className="text-[#7E57C2] font-heading text-sm tracking-[0.4em] mb-3">COMMON QUESTIONS</p>
              ...
              <SectionReveal key={i} delay={i * 0.05}>
                <details className="group border-b border-white/[0.06]">
                  <summary className="flex justify-between items-center py-6 cursor-pointer list-none select-none">
                    <span className="font-heading text-xl text-white tracking-wide pr-4 group-hover:text-[#7E57C2] transition-colors">
                      {faq.q}
                    </span>
          ...
          <div className="mt-8">
            <Link href="/faq" className="text-gray-600 hover:text-[#7E57C2] text-sm transition-colors">
