    ...
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <SectionReveal>
              <div className="border border-white/[0.06] p-8 lg:p-10 hover:border-[#9B4FDE]/20 transition-all duration-500">
                <p className="text-[#9B4FDE] font-heading text-xs tracking-[0.3em] mb-6">BEST VALUE</p>
                <p className="font-heading text-6xl text-white mb-2">$200</p>
                <p className="text-gray-600 text-sm mb-6">5-day camp package</p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block bg-[#7B2FBE] text-white font-heading text-lg px-6 py-3 hover:bg-white transition-all duration-300 tracking-wide text-center glow-purple"
                >
                  BOOK 5-DAY PACK
                </a>
              </div>
            ...
            <SectionReveal delay={0.1}>
              <div className="border border-white/[0.06] p-8 lg:p-10 hover:border-[#9B4FDE]/20 transition-all duration-500">
                ...
                <p className="font-heading text-6xl text-white mb-2">$50</p>
            ...
            <SectionReveal delay={0.2}>
              <div className="border border-white/[0.06] p-8 lg:p-10 hover:border-[#9B4FDE]/20 transition-all duration-500">
                ...
                <p className="font-heading text-6xl text-white mb-2">$30</p>
          ...
          <SectionReveal delay={0.1}>
            <p className="text-gray-600 text-sm mt-8 text-center">
              NSW Active Kids vouchers accepted. OVA jerseys available separately.
            </p>
          </SectionReveal>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionReveal>
            <div className="mb-16">
              <p className="text-[#9B4FDE] font-heading text-sm tracking-[0.4em] mb-3">NEXT CAMP</p>
